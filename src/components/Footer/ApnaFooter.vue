<template>
  <div class="text-gray-400 bg-gray-900 border-t border-gray-800">
      ...
      >
        <div class="relative sm:w-64 w-40 sm:mr-4 mr-2">
          ...
          <input
            ...
            id="footer-field"
            name="footer-field"
            class="w-full bg-gray-800 bg-opacity-40 rounded border border-gray-700 focus:ring-2 focus:ring-green-900 focus:bg-transparent focus:border-green-500 text-base outline-none text-gray-100 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
          />
        </div>
        <button
        ...
        <p
          class="text-gray-500 text-sm md:ml-6 md:mt-0 mt-2 text-center sm:text-left"
        >
  ...
  <div class="bg-gray-800 bg-opacity-75">
    ...
    >
      ...
      <span
        class="sm:ml-auto sm:mt-0 mt-2 sm:w-auto w-full sm:text-left text-center text-gray-400 text-sm"
